...
<div class="login-box">
	...
	<form>
		<div class="user-box">
			<input type="text" name="" required=""> <label>아이디</label>
		</div>
		<div class="user-box">
			<input type="password" name="" required=""> <label>비밀번호</label>
		</div>
		<div class="user-box">
			<input type="text" name="" required=""> <label>이 름</label>
		</div>
		<div class="user-box">
			<input type="text" name="" required=""> <label>주 소</label>
		</div>
		<a href="#"> <span></span> <span></span> <span></span> <span></span>
			가입하기
		</a> <a href="/"> <span></span> <span></span> <span></span> <span></span>
			메인화면
		</a>
	</form>
</div>
